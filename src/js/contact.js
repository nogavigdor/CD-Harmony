...
*/ isValid=true;
        if (isValid) {
            ...
            console.log('checking base url with contact');
                ...
                action: 'contact',
                    ...
                    .then(function (token) {
                        ...
                        .then((response) => {
                           ...
                           if(responseText.errors !== "") { // If there is an error
                          
                            //update email error message
                            emailError.classList.remove("hidden");      
                            emailError.innerHTML = responseText.errors.email;
                            //update title error message
                            titleError.classList.remove("hidden");
                            titleError.innerHTML = responseText.errors.title;
                            //update message error message
                            messageError.classList.remove("hidden");
                            messageError.innerHTML = responseText.errors.message;
