  ...
  postal_code_id varchar(4) PRIMARY KEY NOT NULL,
 ...
 (
  ...
  product_id int,
  FOREIGN KEY (product_id) REFERENCES productds(product_id);

 ) ENGINE=InnoDB;

 CREATE TABLE reviews
 (
  review_id in AUTO_INCEREMENT NOT NULL PRIMARY KEY,
 ...
 (
  rating_id in AUTO_INCEREMENT NOT NULL PRIMARY KEY,
  `value` int NOT NULL,
   created timestamp NOT NULL,
  product_id int,
  user_id int,
