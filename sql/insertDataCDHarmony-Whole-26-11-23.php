...
try {
    ...
    foreach ($data as $artistName => $albums) {
        ...
        foreach ($albums as $album) {
            ...
            $stmtConditionNew = $db->prepare("INSERT INTO products_conditions (price, quantity_in_stock, product_id, condition_id) VALUES (:priceNew, :quantityInStockNew, :productId, (SELECT condition_id FROM conditions WHERE title = 'new'))");
            ...
            $stmtConditionUsed = $db->prepare("INSERT INTO products_conditions (price, quantity_in_stock, product_id, condition_id) VALUES (:priceUsed, :quantityInStockUsed, :productId, (SELECT condition_id FROM conditions WHERE title = 'used'))");
