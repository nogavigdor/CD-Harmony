        ...
        if (isset($artistAlbumsData['topalbums']['album'])) {
            ...
            foreach ($artistAlbumsData['topalbums']['album'] as $album) {
                ...
                if (isset($albumInfoData['album']['tracks']['track'])) {
                    $trackList = $albumInfoData['album']['tracks']['track'];

                    if (!is_array($trackList)) {
                        // Handle the case where there's a single track represented as a single string
                        $trackList = [$trackList];
                    }
                    ...
                    foreach ($trackList as $track) {
                        if (is_array($track)) {
                            ...
                            // Handle the case where a track is represented as a single string
                            $trackName = $track;
                            $trackDuration = 'N/A'; // Or handle it as you see fit
                        }
