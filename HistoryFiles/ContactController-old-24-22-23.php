                ...
                //error_log('Error Output: ' . print_r($error_output, true));
                    ...
                    if (isset($recaptcha))  {
                            ...
                            if ($recaptchaResult) {
                                ...
                                SessionManager::setSessionVariable('contact_success', 'Your contact form has been submitted successfully.');
                                ...
                                exit();
                                     ...
                                     // Sets a session variable for contact success
                                SessionManager::setSessionVariable('contact_success', 'There has been a problem with your contact form submission. Please try again later');
                                  // Send JSON response
                     ...
                     /*
                            ...
                            ini_set('smtp_username', 'contact@cdhrmny.dk');
                            ...
                            ini_set('sendmail_from', 'contact@cdhrmny.dk');
...
/*
                        ...
                        $mail->Username = "contact@cdhrmny.dk";
...
*/
            ...
            //input validtion was not successfull 
                ...
                SessionManager::setSessionVariable('output', $output);
