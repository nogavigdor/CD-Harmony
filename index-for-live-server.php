...
route('/admin/product/delete/(\d+)', 'DELETE', function ($id) {
    $controller = new ProductController();
...
route('/admin/articles/', 'GET', function ($id) {
    $controller = new ArticleController();
    $controller->showAllArticles($id);
});

route('/admin/article/delete/(\d+)', 'POST', function ($id) {
    $controller = new ArticleController();
    $controller->deleteArticle($id);
});

route('/admin/article/update/(\d+)', 'POST', function ($id) {
    $controller = new ArticleController();
    $controller->updateArticle($id);
});

route('/admin/article/create/(\d+)', 'POST', function ($id) {
    $controller = new ArticleController();
...
route('/admin/company/', 'POST', function () {
    $controller = new CompanyController();
...
route('/admin/products/', 'POST', function () {
    $controller = new AdminController();
